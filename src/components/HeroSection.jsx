                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                        <div className="content md:text-left">
                            <h1 className='text-4xl md:text-64 md:leading-snug font-bold text-white'>
                            Gatsbychat, where Privacy seamlessly meets Connection.
                            </h1>
                            <p className='text-sm md:text-xl text-white leading-loose mb-30'>
                            A revolutionary platform for social networking, messaging, and meetings, empowering users to connect, share, and thrive in a secure digital ecosystem that prioritizes privacy and real-time communication.
                            </p>
                            <Stack spacing={2} direction="row" className='btn flex gap-4 md:gap-2 items-center mb-30 justify-center md:justify-start'>
                                ...
                                <Button href='/get-started' variant="text" className='px-50 py-5 text-white underline underline-offset-2 font-semibold text-lg rounded-full h-14' >Login</Button>
                            </Stack>
